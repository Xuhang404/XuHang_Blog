...
export default function AdminAbout() {
  ...
  return (
    <div>
      <h1 className="font-serif-heading text-2xl text-ink mb-10">
        编辑关于页
      </h1>
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full border border-divider bg-paper px-3 py-2.5 text-sm text-ink placeholder:text-smoke/40 focus:outline-none focus:border-vermillion transition-colors duration-200 resize-y"
          />
        </div>
        <div>
          <label className="block text-xs text-smoke/60 uppercase tracking-[0.15em] mb-2">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-divider bg-paper px-3 py-2.5 text-sm text-ink placeholder:text-smoke/40 focus:outline-none focus:border-vermillion transition-colors duration-200"
          />
        </div>
        <div>
          <label className="block text-xs text-smoke/60 uppercase tracking-[0.15em] mb-2">
